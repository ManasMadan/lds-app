...
import { fetchAllSMEStats } from "@/lib/api/stats";

export default function AllSMEStats() {
  const { data, isLoading, error } = useQuery({
    queryKey: ["allSmeStats"],
    queryFn: () => fetchAllSMEStats(),
  });
  ...
  return (
    <div className="space-y-4">
      <Card>
        <CardHeader>
          <CardTitle>All SME Performance Reports</CardTitle>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Overall SME Performance</CardTitle>
        </CardHeader>
        <CardContent>
          <div className="grid grid-cols-3 gap-4">
            <div>
              ...
              <p className="text-3xl font-bold">
                {data.overallPerformance.totalQuestionsSubmitted}
              </p>
            </div>
            <div>
